...
- **default_entity_type** *(optional)*  
  A character scalar (`"country"`, `"institution"`, or `"aggregate"`, etc.) to assign as the entity type where no match is found. This value only applies if `"entity_type"` is requested in `output_cols`.
