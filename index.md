...
[![r-econid
website](reference/figures/logo.png)](https://teal-insights.github.io/r-econid/)
...
2.  **Name and code matching**  
    ...
    looks in your dataset for names (and optionally codes) that might
    match an entity. It:
...
4.  **Handling missing and custom cases**
    ...
    - Custom entities can be added using
      [`add_entity_pattern()`](https://teal-insights.github.io/r-econid/reference/add_entity_pattern.md)
...
The
[`standardize_entity()`](https://teal-insights.github.io/r-econid/reference/standardize_entity.md)
function can be used to standardize multiple entities in the same
dataset by using the `prefix` parameter:
...
The
[`add_entity_pattern()`](https://teal-insights.github.io/r-econid/reference/add_entity_pattern.md)
function allows you to add custom entity patterns to the package. This
is useful if you need to standardize entities that are not in the
default list.
...
The
[`reset_custom_entity_patterns()`](https://teal-insights.github.io/r-econid/reference/reset_custom_entity_patterns.md)
function allows you to clear all custom entity patterns that have been
added during the current R session. This is useful when you want to
start fresh with only the default entity patterns.
